describe :fileutils_copy, :shared => true do
  require 'fileutils'
  ...
  ruby_version_is "1.9.2" do
    ...
    it "should support files with various encodings" do
      ...
      def test_copy_with_encodings(source, destination)
      ...
      test_copy_with_encodings 'test', M17n.string_cp1250
      test_copy_with_encodings M17n.string_cp1250, M17n.string_utf_8
      test_copy_with_encodings M17n.string_utf_8, M17n.string_us_ascii

      Dir[File.join(@test_dir, '*')].size.should == 4
    end
  end
end
